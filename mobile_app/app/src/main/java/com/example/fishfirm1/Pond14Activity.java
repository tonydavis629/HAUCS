...
public class Pond14Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pond14);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                temperatureBtn.setText(temperature+"°C");
                if (temperature > 30) {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent =new Intent(Pond14Activity.this,MainActivity.class);
