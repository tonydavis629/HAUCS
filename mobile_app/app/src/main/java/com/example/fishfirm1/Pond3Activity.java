...
public class Pond3Activity extends AppCompatActivity {

    Button do_statusBtn,temperatureBtn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pond3);
        ...
        DatabaseReference ref = database.getReference("ponds/3");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent =new Intent(Pond3Activity.this,MainActivity.class);
