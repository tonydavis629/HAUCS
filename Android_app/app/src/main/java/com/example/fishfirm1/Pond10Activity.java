...
public class Pond10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pond10);
        ...
        DatabaseReference ref = database.getReference("ponds/10");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent =new Intent(Pond10Activity.this,MainActivity.class);
