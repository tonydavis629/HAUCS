...
public class Pond11Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pond11);
        ...
        DatabaseReference ref = database.getReference("ponds/11");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent =new Intent(Pond11Activity.this,MainActivity.class);
