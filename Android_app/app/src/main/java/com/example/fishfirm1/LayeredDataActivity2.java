...
public class LayeredDataActivity2 extends AppCompatActivity {
    GPSData gpsData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference ref = database.getReference("ponds/Pond2");
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    Log.wtf("timestampkey", timeStampKeyList.toString());
                    try {
    ...
    private void callAdapter() {
        TimestampRecyclerAdapter adapter=new TimestampRecyclerAdapter(LayeredDataActivity2.this,timeStampModels,timeStampKeyList);
        timestampRecycler.setLayoutManager(new LinearLayoutManager(LayeredDataActivity2.this));
