...
public class Pond8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pond8);
        ...
        DatabaseReference ref = database.getReference("ponds/8");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent =new Intent(Pond8Activity.this,MainActivity.class);
