...
public class Pond6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pond6);
        ...
        DatabaseReference ref = database.getReference("ponds/6");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent =new Intent(Pond6Activity.this,MainActivity.class);
