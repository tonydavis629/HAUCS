...
public class Pond4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pond4);
        ...
        DatabaseReference ref = database.getReference("ponds/4");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent =new Intent(Pond4Activity.this,MainActivity.class);
