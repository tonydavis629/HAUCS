...
public class Pond5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pond5);
        ...
        DatabaseReference ref = database.getReference("ponds/5");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent =new Intent(Pond5Activity.this,MainActivity.class);
