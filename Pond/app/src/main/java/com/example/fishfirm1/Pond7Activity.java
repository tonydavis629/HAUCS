...
public class Pond7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pond7);
        ...
        DatabaseReference ref = database.getReference("ponds/7");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent =new Intent(Pond7Activity.this,MainActivity.class);
