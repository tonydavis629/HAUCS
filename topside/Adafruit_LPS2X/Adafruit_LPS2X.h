...
#define LPS28HB_CHIP_ID 0xB4 ///< LPS25HB default device id from WHOAMI
#define LPS28_CTRL_REG1 0x10 ///< First control register. Includes BD & ODR
#define LPS28_CTRL_REG2 0x11 ///< Second control register. Includes SW Reset
#define LPS28_CTRL_REG3                                                        \
  0x12 ///< Third control register. Includes interrupt polarity
#define LPS28_CTRL_REG4                                                        \
  0x13 ///< Fourth control register. Includes DRDY INT control
#define LPS28_INTERRUPT_CFG 0x0B ///< Interrupt control register
#define LPS28_THS_P_L_REG 0x0C   ///< Pressure threshold value for int
...
/** Specific subclass for LPS25 variant */
class Adafruit_LPS28 : public Adafruit_LPS2X {
public:
  lps28_rate_t getDataRate(void);
  void setDataRate(lps28_rate_t data_rate);
  void configureInterrupt(bool activelow, bool opendrain,
                          bool pres_high = false, bool pres_low = false);
